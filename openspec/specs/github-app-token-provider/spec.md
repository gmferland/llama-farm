# Spec: GitHub App Token Provider

## Purpose

Generates and caches short-lived GitHub installation access tokens by authenticating as a GitHub App, enabling the coding agent to act on repositories without a static personal access token.
