# Spec: Docker Secret Loader

## Purpose

Provides a single function for reading named secrets, preferring Docker secret files at `/run/secrets/<name>` with a fallback to environment variables of the same name.
