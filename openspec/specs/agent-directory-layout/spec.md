# Spec: Agent Directory Layout

## Purpose

Defines the filesystem and module organization conventions for agent services within the `agent/` directory. Each agent is a self-contained service with its own build context, and individual agents follow module-level separation of concerns.
