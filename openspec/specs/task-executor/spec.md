...
Provides the workspace lifecycle and tool implementations used by the coding agent: cloning repos, reading/writing files, running shell commands, committing changes, and posting GitHub comments.
